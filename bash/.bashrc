...
get_distro () {
    lsb_release -c | awk '{print $2}' | tr '[:lower:]' '[:upper:]'
}

if [ "$color_prompt" = yes ]; then
    PS1='($(get_distro)) ${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\] \$ '
else
    PS1='($(get_distro)) ${debian_chroot:+($debian_chroot)}\u@\h:\w \$ '
fi
